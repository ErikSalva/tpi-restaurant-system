...
| **Error Rate**   | **Pestaña Errors**     | **Valor:** Muestra el porcentaje de transacciones que resultaron en un error. Un alto _Error Rate_ (típicamente > 1%) indica un problema crítico en producción. |
...
- **Seguridad:** El flujo OAuth2/JWT es básico. Carece de implementación de **Refresh Tokens**, mecanismos de **revocación de tokens** y limitación de intentos de inicio de sesión (_rate limiting_).
...
| Segunda entrega | v2.0.0 | e1795ba       |
